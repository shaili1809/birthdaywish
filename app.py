...
# width is used to set the width of an image
    ...
    st.text("I don't know about the future,we will be in touch or not but ")
    st.text("i promise you ,you will receive a upgraded version of a web page wish") 
